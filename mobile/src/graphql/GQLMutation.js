...
export const MUT_UPDATE_USER_PHONE = gql`
  mutation UpdateUserPhone($userToken: String!, $phone: String!) {
    updateUserPhone(userToken: $userToken, phone: $phone) {
      ...UserTypeDetails
    }
  }
...
export const MUT_VERIFY_USER_PHONE = gql`
  mutation VerifyUserPhone($userToken: String!, $code: String!) {
    verifyUserPhone(userToken: $userToken, code: $code) {
      ...UserTypeDetails
    }
  }
...
// favorite
export const MUT_SWITCH_FAVORITE = gql`
  mutation SwitchBlock($userToken: String!, $imageid: ID!, $favorited: Boolean!, $word: String) {
    switchFavorite(
      userToken: $userToken
      imageid: $imageid
      favorited: $favorited
