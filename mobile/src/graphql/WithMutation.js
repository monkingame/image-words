...
import { MUT_VISIBLE_MODAL_LISTWORDS } from './GQLLocal';
...
// listwords对话框
export const withMutVisibleModalListWords = () => {
  return graphql(MUT_VISIBLE_MODAL_LISTWORDS, {
    name: `updateVisibleModalListWords`,
  });
}
